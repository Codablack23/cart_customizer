...
Command: npx gltfjsx@6.2.3 Six_Seater_Kart2.glb --t
*/
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/models/Six_Seater_Kart2.glb') as GLTFResult
  return (
...
useGLTF.preload('/models/Six_Seater_Kart2.glb')
