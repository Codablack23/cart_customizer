...
Command: npx gltfjsx@6.2.7 public/models/Kartfourseatfrontbackface.glb --t
*/
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/Kartfourseatfrontbackface.glb') as GLTFResult
  return (
...
useGLTF.preload('/Kartfourseatfrontbackface.glb')
